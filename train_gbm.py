...
# Data & Results 
parser.add_argument('--dataset', type=str, default='MNIST', choices=('MNIST','CIFAR10','speckles','light_sheets'), help='Choose the dataset')
...
timesteps=(sum_to-sum_from)+1

n_timesteps = timesteps//sum_every_n_steps if timesteps == sum_every_n_steps*int(timesteps/sum_every_n_steps) else timesteps//sum_every_n_steps + 1
