#!/bin/bash
TEMPLATE_NAME=template-cond-diffusion
...
oc process ${TEMPLATE_NAME} \
    -p JOBNAME=diff-cifar-cond-1exp \
    ...
    -p ARG4=--logdir=/nfs/conditionalDDPM/logs/cifar-cond1 \
    ...
    -p ARG12=--train_num_steps=100000 \
    -p ARG13=--model_type=conditional \
    -p GPUTYPE=gputitan \
    | oc create -f -
